              ...
              <div className="text-gray-300 prose prose-invert max-w-none">
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    h1: ({node, ...props}) => <h1 className="text-3xl font-bold mb-4 mt-6 break-words" {...props} />,
                    h2: ({node, ...props}) => <h2 className="text-2xl font-bold mb-3 mt-5 break-words" {...props} />,
                    h3: ({node, ...props}) => <h3 className="text-xl font-bold mb-2 mt-4 break-words" {...props} />,
                    ul: ({node, ...props}) => <ul className="list-disc list-outside mb-4 pl-5" {...props} />,
                    ...
                    code: ({node, inline, ...props}) => 
                      inline ? (
                        <code className="bg-gray-800 text-gray-200 rounded px-1 py-0.5 break-words" {...props} />
                      ) : (
                        <pre className="bg-gray-800 text-gray-200 p-3 rounded mb-4 overflow-x-auto whitespace-pre-wrap break-words">
                          <code className="block break-words" {...props} />
                        </pre>
                      ),
                    blockquote: ({node, ...props}) => (
                      <blockquote className="border-l-4 border-gray-500 pl-4 italic my-4 break-words" {...props} />
                    ),
                    a: ({node, ...props}) => (
                      <a className="text-blue-400 hover:underline break-words" target="_blank" rel="noopener noreferrer" {...props} />
                    ),
                    img: ({node, ...props}) => (
                    ...
                    th: ({node, ...props}) => (
                      <th className="px-3 py-2 bg-gray-800 text-left text-xs font-medium text-gray-300 uppercase tracking-wider break-words" {...props} />
                    ),
                    td: ({node, ...props}) => (
                      <td className="px-3 py-2 text-sm text-gray-300 break-words" {...props} />
                    ),
                  }}
                >
                  {paper.summary}
